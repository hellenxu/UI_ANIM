...
public class CardEditActivity extends AppCompatActivity {
    ...
    /**
     * update button text: previous, next or done
     */
    ...
    public void loadPager() {
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 2) {
                    ...
                    //1) stop inputting cvv number, and try to edit expiry again; 2) or input card holder name.
        ...
        mCardAdapter.setOnCardEntryCompleteListener(new ICardEntryCompleteListener() {
            ...
            public void onCardEntryEdit(int currentIndex, String entryValue) {
                //magic number: 0) card number; 1) expiry; 2) cvv; 3) holder name
                switch (currentIndex) {
                    case 0:
