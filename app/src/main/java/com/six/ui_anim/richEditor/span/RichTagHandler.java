...
public class RichTagHandler implements Html.TagHandler {
    ...
    private static final String STRIKE_THROUGH_S = "s";
    private static final String STRIKE_THROUGH = "strike";
    private static final String STRIKE_THROUGH_DEL = "del";
    ...
    public void handleTag(boolean opening, String tag, Editable output, XMLReader xmlReader) {
        if (opening) {
            if (tag.equalsIgnoreCase(BULLET_LI)) {
                ...
                start(output, new Li());
            } else if (tag.equalsIgnoreCase(STRIKE_THROUGH_S) || tag.equalsIgnoreCase(STRIKE_THROUGH) || tag.equalsIgnoreCase(STRIKE_THROUGH_DEL)) {
